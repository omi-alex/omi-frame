...
class QModelTypeTime extends QModelTypeScalar 
{
	/**
	 ...
	 * 
	 * @return QModelTypeTime
	 */
	public static function GetType()
	{
		return self::$type["time"] ?: (self::$type["time"] = new QModelTypeTime());
	}
	/**
	...
	{
		return array(QSqlTableColumn::TypeTime, 
