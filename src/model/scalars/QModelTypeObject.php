...
class QModelTypeObject extends QModelTypeScalar 
{
	/**
	 * The instance of the object
	 *
	 * @var QModelTypeObject
	 */
	private static $type;
	 ...
	 * 
	 * @return QModelTypeObject
	 */
	public static function GetType()
	{
		return self::$type["object"] ?: (self::$type["object"] = new QModelTypeObject());
	}
	/**
