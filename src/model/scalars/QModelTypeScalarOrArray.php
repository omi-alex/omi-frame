...
class QModelTypeScalarOrArray extends QModelTypeScalar 
{
	/**
	 * The instance of the object
	 *
	 * @var QModelTypeScalarOrArray
	 */
	private static $type;
	 ...
	 * 
	 * @return QModelTypeScalarOrArray
	 */
	public static function GetType()
	{
		return self::$type["scalarorarray"] ?: (self::$type["scalarorarray"] = new QModelTypeScalarOrArray());
	}
	/**
	 * Assigns a value to the passed variable. 
	 * If the function returns true(boolean) than it was a success.
	 *
	 * @param scalarorarray $target
	 * @param mixed $value
	 * 
	 * @return boolean
	 */
	 ...
	 *
	 * @param scalarorarray $variable_1
	...
	{
		return (is_scalar($variable) || is_array($variable));
	}
	/**
